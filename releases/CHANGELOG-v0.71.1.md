...
# v0.71.1 - 2023-02-27
### Bug Fixes 🐞
- remove invalid feature gates ([#4903](https://github.com/Azure/aks-engine/issues/4903))
- Set enableLoopbackDSR in Windows Azure CNI configuration for WinDSR ([#4793](https://github.com/Azure/aks-engine/issues/4793))
- opt out of 'Anitimalware Signatures SDP' extension for Windows VHDs ([#4888](https://github.com/Azure/aks-engine/issues/4888))
...
- ensure kube-addon-manager + apiserver monitor ([#4759](https://github.com/Azure/aks-engine/issues/4759))
- ensure iovisor is not present in apt config ([#4761](https://github.com/Azure/aks-engine/issues/4761))
- ensure we delete init kube-addon-manager ([#4743](https://github.com/Azure/aks-engine/issues/4743))
- update windows binary URL for Azure Stack ([#4742](https://github.com/Azure/aks-engine/issues/4742))
- Enable ipforwarding on agent nic for Azure CNI dualstack scenario ([#4728](https://github.com/Azure/aks-engine/issues/4728))
- bypass systemd-resolved but use the resolv.conf it generates ([#4726](https://github.com/Azure/aks-engine/issues/4726))
- Allow TCP DNS requests to work to upstream DNS in Azure ([#4721](https://github.com/Azure/aks-engine/issues/4721))
- fetch releases via the GitHub API optionally using GH Token ([#4711](https://github.com/Azure/aks-engine/issues/4711))
- Fix release page HTML scrape to get version ([#4706](https://github.com/Azure/aks-engine/issues/4706))
- optimize secondary IP addresses ([#4689](https://github.com/Azure/aks-engine/issues/4689))
- enable Accelerated Networking settings and pick up the right adapter in windows azure function  ([#4585](https://github.com/Azure/aks-engine/issues/4585))
...
- overwrite ubuntu1604 distro for upgrade and block deploy and generate scenarios on Azure Stack Hub ([#4612](https://github.com/Azure/aks-engine/issues/4612))
...
- really use eastus for release automation ([#4923](https://github.com/Azure/aks-engine/issues/4923))
- use eastus for release automation ([#4921](https://github.com/Azure/aks-engine/issues/4921))
- use westus3 for release automation ([#4920](https://github.com/Azure/aks-engine/issues/4920))
...
- use 18.04 for Linux VHD job ([#4710](https://github.com/Azure/aks-engine/issues/4710))
- pod churn tests for large clusters ([#4695](https://github.com/Azure/aks-engine/issues/4695))
...
- add on-demand cluster config GitHub Action ([#4632](https://github.com/Azure/aks-engine/issues/4632))
...
### Documentation 📘
- print deprecation message to stderr ([#4905](https://github.com/Azure/aks-engine/issues/4905))
- update Azure Stack Hub Linux VHD version for v0.70.0 ([#4889](https://github.com/Azure/aks-engine/issues/4889))
- Azure Stack Hub doc update for v0.70.0 ([#4856](https://github.com/Azure/aks-engine/issues/4856))
...
- fix addon name in Calico `logSeverityScreen` example ([#4685](https://github.com/Azure/aks-engine/issues/4685))
...
### Features 🌈
- add support for Kubernetes v1.24.3 ([#4915](https://github.com/Azure/aks-engine/issues/4915))
- add support for Kubernetes v1.23.9 ([#4914](https://github.com/Azure/aks-engine/issues/4914))
- add support for Kubernetes v1.22.12 ([#4913](https://github.com/Azure/aks-engine/issues/4913))
- add support for Kubernetes v1.21.14 ([#4911](https://github.com/Azure/aks-engine/issues/4911))
- add support for Kubernetes v1.23.8 ([#4909](https://github.com/Azure/aks-engine/issues/4909))
- add support for Kubernetes v1.22.11 ([#4910](https://github.com/Azure/aks-engine/issues/4910))
- add support for Kubernetes v1.24.2 ([#4908](https://github.com/Azure/aks-engine/issues/4908))
- add support for Kubernetes v1.21.13 ([#4900](https://github.com/Azure/aks-engine/issues/4900))
- add support for Kubernetes v1.22.10 ([#4899](https://github.com/Azure/aks-engine/issues/4899))
- add support for Kubernetes v1.23.7 ([#4901](https://github.com/Azure/aks-engine/issues/4901))
- add support for Kubernetes v1.24.1 ([#4902](https://github.com/Azure/aks-engine/issues/4902))
- Deprecate Kubernetes versions 1.19 and 1.20 ([#4894](https://github.com/Azure/aks-engine/issues/4894))
- add chinaeast3 and chinanorth2 to AzureChinaCloud ([#4895](https://github.com/Azure/aks-engine/issues/4895))
- add support for Kubernetes v1.22.9 ([#4883](https://github.com/Azure/aks-engine/issues/4883))
- add support for Kubernetes v1.23.6 ([#4884](https://github.com/Azure/aks-engine/issues/4884))
- add support for Kubernetes v1.24.0 ([#4890](https://github.com/Azure/aks-engine/issues/4890))
- add support for Kubernetes v1.21.12 ([#4882](https://github.com/Azure/aks-engine/issues/4882))
- add support for Kubernetes v1.23.5 ([#4861](https://github.com/Azure/aks-engine/issues/4861))
- add support for Kubernetes v1.22.8 ([#4860](https://github.com/Azure/aks-engine/issues/4860))
- add support for Kubernetes v1.21.11 ([#4859](https://github.com/Azure/aks-engine/issues/4859))
...
- add support for Kubernetes v1.23.0-rc.0 ([#4756](https://github.com/Azure/aks-engine/issues/4756))
- add support for Kubernetes v1.20.13 ([#4747](https://github.com/Azure/aks-engine/issues/4747))
- add support for Kubernetes v1.22.4 ([#4749](https://github.com/Azure/aks-engine/issues/4749))
- add support for Kubernetes v1.21.7 ([#4748](https://github.com/Azure/aks-engine/issues/4748))
- add support for Kubernetes v1.23.0-beta.0 ([#4746](https://github.com/Azure/aks-engine/issues/4746))
- Update Antrea version to v1.3.0 ([#4729](https://github.com/Azure/aks-engine/issues/4729))
- add support for Kubernetes v1.23.0-alpha.4 ([#4736](https://github.com/Azure/aks-engine/issues/4736))
- add support for Kubernetes v1.21.6 ([#4724](https://github.com/Azure/aks-engine/issues/4724))
- add support for Kubernetes v1.20.12 ([#4723](https://github.com/Azure/aks-engine/issues/4723))
- add support for Kubernetes v1.19.16 ([#4722](https://github.com/Azure/aks-engine/issues/4722))
- add support for Kubernetes v1.22.3 ([#4727](https://github.com/Azure/aks-engine/issues/4727))
- updates for container monitoring addon omsagent agent Oct2021 release ([#4703](https://github.com/Azure/aks-engine/issues/4703))
- upgrade csi disk driver to v1.8, file driver to v1.7 ([#4699](https://github.com/Azure/aks-engine/issues/4699))
- add support for Kubernetes v1.23.0-alpha.3 ([#4680](https://github.com/Azure/aks-engine/issues/4680))
...
- add support for Kubernetes v1.21.4 ([#4626](https://github.com/Azure/aks-engine/issues/4626))
- add support for Kubernetes v1.22.1 ([#4625](https://github.com/Azure/aks-engine/issues/4625))
- add support for Kubernetes v1.19.14 ([#4617](https://github.com/Azure/aks-engine/issues/4617))
- add support for Kubernetes v1.20.10 ([#4618](https://github.com/Azure/aks-engine/issues/4618))
- add support for Kubernetes v1.22.0 ([#4609](https://github.com/Azure/aks-engine/issues/4609))
- allow setting apiserver verbosity ([#4563](https://github.com/Azure/aks-engine/issues/4563))
...
- Update Azure constants ([#4925](https://github.com/Azure/aks-engine/issues/4925))
- add qatarcentral region ([#4919](https://github.com/Azure/aks-engine/issues/4919))
- install 2022 7C updates to help vaildate windows networking fixes ([#4916](https://github.com/Azure/aks-engine/issues/4916))
- add support for Kubernetes v1.23.6 on Azure Stack ([#4912](https://github.com/Azure/aks-engine/issues/4912))
- get-logs copies kube-system logs from file system ([#4904](https://github.com/Azure/aks-engine/issues/4904))
- Update Azure constants ([#4898](https://github.com/Azure/aks-engine/issues/4898))
- update containerd to 1.5.11 ([#4891](https://github.com/Azure/aks-engine/issues/4891))
- Update Azure constants ([#4896](https://github.com/Azure/aks-engine/issues/4896))
- update out-of-tree cloud-provider-azure images ([#4892](https://github.com/Azure/aks-engine/issues/4892))
...
- update moby Linux packages to 20.10.11 ([#4766](https://github.com/Azure/aks-engine/issues/4766))
- update metrics-server to v0.5.2 ([#4763](https://github.com/Azure/aks-engine/issues/4763))
- remove iovisor apt dependencies ([#4744](https://github.com/Azure/aks-engine/issues/4744))
- Update Azure constants ([#4740](https://github.com/Azure/aks-engine/issues/4740))
- upgrade csi driver config ([#4745](https://github.com/Azure/aks-engine/issues/4745))
- Update Azure constants ([#4737](https://github.com/Azure/aks-engine/issues/4737))
- Update Azure constants ([#4644](https://github.com/Azure/aks-engine/issues/4644))
- update cluster-autoscaler to 1.22.1 ([#4731](https://github.com/Azure/aks-engine/issues/4731))
- Allow dualstack in AzureCNI transparent mode ([#4714](https://github.com/Azure/aks-engine/issues/4714))
- update latest cni version v1.4.13 in aks-engine ([#4693](https://github.com/Azure/aks-engine/issues/4693))
- add k8s 1.22 to no-egress validation actions ([#4690](https://github.com/Azure/aks-engine/issues/4690))
- remove support for Kubernetes v1.18.x ([#4676](https://github.com/Azure/aks-engine/issues/4676))
...
- upgrade Azure CNI to 1.4.9 ([#4616](https://github.com/Azure/aks-engine/issues/4616))
- Update Azure constants ([#4613](https://github.com/Azure/aks-engine/issues/4613))
...
### Revert Change ◀️
- "fix: ensure we delete init kube-addon-manager ([#4743](https://github.com/Azure/aks-engine/issues/4743))" ([#4752](https://github.com/Azure/aks-engine/issues/4752))
...
- retry create pod from file if not exist ([#4732](https://github.com/Azure/aks-engine/issues/4732))
- fix Rotate-Cert GINKGO config for Azure Stack ([#4707](https://github.com/Azure/aks-engine/issues/4707))
- validate codebase filepath after checkout ([#4720](https://github.com/Azure/aks-engine/issues/4720))
- errata in test cluster config validate ([#4719](https://github.com/Azure/aks-engine/issues/4719))
- validate cluster config in test cluster job ([#4718](https://github.com/Azure/aks-engine/issues/4718))
- quotes errata in test cluster config spec ([#4717](https://github.com/Azure/aks-engine/issues/4717))
- generic cluster config test ([#4716](https://github.com/Azure/aks-engine/issues/4716))
- run vmss-health-check.sh conditionally ([#4712](https://github.com/Azure/aks-engine/issues/4712))
- always use 18.04-LTS for CI jobs ([#4694](https://github.com/Azure/aks-engine/issues/4694))
...
#### Please report any issues here: https://github.com/Azure/aks-engine/issues/new### BREAKING CHANGE

the default apiServer verbosity changes from 4 to 2.


[Unreleased]: https://github.com/Azure/aks-engine/compare/v0.71.1...HEAD
